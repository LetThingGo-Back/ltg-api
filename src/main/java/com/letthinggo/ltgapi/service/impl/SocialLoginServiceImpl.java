...
public class SocialLoginServiceImpl implements SocialLoginService {
    ...
    public TokenDto login(String providerName, String code) {
        ...
        OAuth2AccessToken oAuth2AccessToken = new OAuth2AccessToken(OAuth2AccessToken.TokenType.BEARER, code, Instant.now(), Instant.now().plus(Duration.ofMinutes(10)));
    ...
    private TokenDto createJwtToken(CustomOAuth2User oAuth2User) {
        ...
        return TokenDto.createToken(accessToken, refreshToken);
    }

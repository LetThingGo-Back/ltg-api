...
import com.letthinggo.ltgapi.global.social.dto.KakaoUser;
...
public final class OAuth2KakaoProviderUserConverter implements ProviderUserConverter<ProviderUserRequest,ProviderUser> {
    ...
    public ProviderUser convert(ProviderUserRequest providerUserRequest) {
        ...
        if (!providerUserRequest.clientRegistration().getRegistrationId().equals(SocialLoginCode.KAKAO.getSocialName())) {
            return null;
        }
        ...
        return new KakaoUser(OAuth2Util.getOtherAttributes(
